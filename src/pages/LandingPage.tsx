...
const FEATURES = {
  uz: [
    {
      icon: Music2,
      title: "Mahalliy fayllar",
      desc: "MP3, FLAC, WAV, OGG, M4A formatlarini qo'llab-quvvatlaydi",
    },
    ...
    {
      icon: MonitorSpeaker,
      title: "Tizim integratsiyasi",
      desc: "Tray ikonka, media tugmalari, mini player",
    },
  ...
  ru: [
    ...
    {
      icon: List,
      title: "Несколько плейлистов",
      desc: "Создавайте и управляйте неограниченными плейлистами",
    },
    { icon: Palette, title: "6 тем оформления", desc: "Default, Fire, Rose, Cyber, Forest, Slate" },
    {
      icon: MonitorSpeaker,
      title: "Системная интеграция",
      desc: "Иконка в трее, медиа-клавиши, мини-плеер",
    },
  ...
  en: [
    ...
    { icon: Palette, title: "6 themes", desc: "Default, Fire, Rose, Cyber, Forest, Slate" },
    {
      ...
      desc: "Tray icon, media keys, mini player",
    },
...
const T = {
  ...
  badge: {
    uz: "Versiya 0.1.0 — Bepul",
    ru: "Версия 0.1.0 — Бесплатно",
    en: "Version 0.1.0 — Free",
  },
  heroTitle: {
  ...
  dlSize: {
    uz: "Sonara_0.1.0_x64-setup.msi · ~30 MB",
    ru: "Sonara_0.1.0_x64-setup.msi · ~30 МБ",
    en: "Sonara_0.1.0_x64-setup.msi · ~30 MB",
  },
  internet: {
...
function tl<T extends Record<Lang, string>>(obj: T, lang: Lang): string {
  return obj[lang];
}
...
function Player3D({
  ...
  const prev = () => {
    ...
    setProgress(TRACKS[(trackIdx - 1 + TRACKS.length) % TRACKS.length].progress);
  };
  const next = () => {
    setTrackIdx((trackIdx + 1) % TRACKS.length);
    setProgress(TRACKS[(trackIdx + 1) % TRACKS.length].progress);
  };
          ...
          >
            ...
            >
              <motion.div
                ...
                style={{
                  height: "100%",
                  background: `linear-gradient(90deg, ${th.accent}99, ${th.accent})`,
                  borderRadius: 4,
                  transition: "background 0.4s",
                }}
              />
          ...
          {TRACKS.map((tr, i) => {
            ...
            return (
              ...
              >
                ...
                {tr.artist} — {tr.title}
                {isActive && (
                  <ChevronRight size={10} style={{ marginLeft: "auto", opacity: 0.6 }} />
                )}
              </motion.div>
            );
          })}
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: "2rem" }}>
          {T.nav[lang].map((label, i) => (
            <motion.button
              key={i}
              whileHover={{ color: "#c8893a" }}
              onClick={() => scrollTo([featRef, themeRef, dlRef][i])}
              style={{
                background: "none",
                border: "none",
                color: "#777",
      ...
      >
        ...
        >
          ...
          >
            {T.heroTitle[lang][0]}
            <br />
            <span style={{ color: "#c8893a" }}>{T.heroTitle[lang][1]}</span>
          </motion.h1>
          ...
          >
            <motion.button
              whileHover={{ scale: 1.03, background: "#e09a45" }}
              whileTap={{ scale: 0.97 }}
            ...
            <motion.a
              whileHover={{ scale: 1.03, color: "#e8e8e8", borderColor: "rgba(255,255,255,0.3)" }}
              whileTap={{ scale: 0.97 }}
          ...
          >
            <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
              <MonitorSpeaker size={14} color="#666" /> Windows 10+
            </span>
            <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
              <Package size={14} color="#666" /> ~30 MB
            </span>
            <span style={{ display: "flex", alignItems: "center", gap: 6, color: "#c8893a" }}>
      ...
      <section ref={themeRef} style={{ background: "#0a0a0f", padding: "6rem 2rem" }}>
        ...
        >
          ...
          <motion.div
            variants={fadeUp}
            style={{ display: "flex", gap: 10, flexWrap: "wrap", marginBottom: "3rem" }}
          >
      ...
      <section
        ref={dlRef}
        style={{ background: "#0d0d12", padding: "6rem 2rem", textAlign: "center" }}
      >
        <motion.div
          style={{ maxWidth: 900, margin: "0 auto" }}
          initial="hidden"
        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: 12, color: "#444", marginTop: "0.75rem" }}>
              {tl(T.dlSize, lang)}
            </div>
            <div
              style={{
